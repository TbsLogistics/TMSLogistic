...
class LetterManagerDetailsAccess
    extends GetView<LetterManagerDetailsAccessController> {
  LetterManagerDetailsAccess(this.regID, {super.key});
  final int regID;

  @override
  var controller = Get.put(LetterManagerDetailsAccessController());
