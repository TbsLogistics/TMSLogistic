...
//   const LetterMyselfCreateSentScreen({super.key});
...
//     return GetBuilder<LetterMyselfCreateSentController>(
//         init: LetterMyselfCreateSentController(),
...
//       LetterMyselfCreateSentController controller, BuildContext context) {
//     return SizedBox(
//       height: 120,
//       child: Column(
//         children: [
...
//           FindDropdown<ListOfSubordinatesModel>(
//             showSearchBox: false,
//             onFind: (String filter) => controller.getDataCustomer(filter),
//             onChanged: (value) {
//               controller.selectMember.value.empID = value!.empID;
//               print(controller.selectMember.value.empID);
//             },
//             dropdownBuilder:
//                 (BuildContext context, ListOfSubordinatesModel? item) {
//               return Card(
...
//                   ),
//                 ),
//                 child: (item?.firstName == null && item!.lastName == null)
//                     ? const ListTile(
//                         title: Text(
//                           "Chọn nhân viên",
//                           style: TextStyle(
...
//                 ListOfSubordinatesModel item, bool isSelected) {
//               return Container(
//                 // height: 100,
