...
class LetterMyselfDetailsScreen extends GetView<LetterMyselfDetailsController> {
  const LetterMyselfDetailsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<LetterMyselfDetailsController>(
      init: LetterMyselfDetailsController(),
  ...
  Widget _buildLoaiPhep(
      Size size, LetterMyselfDetailsModel items, String hintText) {
