...
class LetterMyselfScreen extends GetView<LetterMyselfController> {
  const LetterMyselfScreen({super.key});

  @override
  Widget build(BuildContext context) {
    var day = DateFormat("dd/MM/yyyy");
    Size size = MediaQuery.of(context).size;
    return GetBuilder<LetterMyselfController>(
      init: LetterMyselfController(),
