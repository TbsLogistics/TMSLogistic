class DriverEditRegisterModel {
  String? code;
  Datain? datain;

  DriverEditRegisterModel({this.code, this.datain});

  DriverEditRegisterModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    datain =
        json['datain'] != null ? new Datain.fromJson(json['datain']) : null;
  }
